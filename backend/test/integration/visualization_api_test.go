...
func (s *VisualizationApiTest) SetupTest() {
	...
	if *isKubeflowMode {
		...
		newVisualizationClient = func() (*api_server.VisualizationClient, error) {
			return api_server.NewKubeflowInClusterVisualizationClient(s.namespace, *isDebugMode, *tlsEnabled)
		}
	} else {
		clientConfig := test.GetClientConfig(*namespace)

		newVisualizationClient = func() (*api_server.VisualizationClient, error) {
			return api_server.NewVisualizationClient(clientConfig, *isDebugMode, *tlsEnabled)
		}
	}
