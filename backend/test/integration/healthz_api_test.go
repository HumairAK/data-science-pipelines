...
func (s *HealthzApiTest) SetupTest() {
	...
	if *isKubeflowMode {
		...
		newHealthzClient = func() (*api_server.HealthzClient, error) {
			return api_server.NewKubeflowInClusterHealthzClient(s.namespace, *isDebugMode, *tlsEnabled)
		}
	} else {
		clientConfig := test.GetClientConfig(*namespace)

		newHealthzClient = func() (*api_server.HealthzClient, error) {
			return api_server.NewHealthzClient(clientConfig, *isDebugMode, *tlsEnabled)
		}
	}
