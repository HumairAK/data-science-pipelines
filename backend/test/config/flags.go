...
var (
	RepoName   = flag.String("repoName", "kubeflow/pipelines", "The name of the repository")
	PullNumber = flag.String("pullNumber", "", "The pull number")
	BranchName = flag.String("branchName", "master", "The branch name")
)
