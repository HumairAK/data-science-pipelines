...
func (s *ProxyTestSuite) SetupTest() {
	...
	if *isKubeflowMode {
		...
		newExperimentClient = func() (*apiserver.ExperimentClient, error) {
			return apiserver.NewKubeflowInClusterExperimentClient(s.namespace, *isDebugMode, *tlsEnabled)
		}
		...
		newExperimentClient = func() (*apiserver.ExperimentClient, error) {
			return apiserver.NewExperimentClient(clientConfig, *isDebugMode, *tlsEnabled)
		}
		newPipelineUploadClient = func() (*apiserver.PipelineUploadClient, error) {
