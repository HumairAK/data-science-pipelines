...
class V2beta1RunDetails(object):
    ...
    def task_details(self):
        ...
        Deprecated: use top-level task APIs and Run.tasks instead. This legacy field remains for backward compatibility only and will be removed in the next major API version.  # noqa: E501
