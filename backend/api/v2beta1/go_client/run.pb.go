...
type PipelineTask_TaskPodType int32

const (
	PipelineTask_UNSPECIFIED PipelineTask_TaskPodType = 0
	PipelineTask_DRIVER      PipelineTask_TaskPodType = 1
	PipelineTask_EXECUTOR    PipelineTask_TaskPodType = 2
)

// Enum value maps for PipelineTask_TaskPodType.
var (
	PipelineTask_TaskPodType_name = map[int32]string{
		0: "UNSPECIFIED",
		1: "DRIVER",
		2: "EXECUTOR",
	}
	PipelineTask_TaskPodType_value = map[string]int32{
		"UNSPECIFIED": 0,
		"DRIVER":      1,
		"EXECUTOR":    2,
	}
...
func (x PipelineTask_TaskPodType) Enum() *PipelineTask_TaskPodType {
	p := new(PipelineTask_TaskPodType)
	*p = x
	return p
}

func (x PipelineTask_TaskPodType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PipelineTask_TaskPodType) Descriptor() protoreflect.EnumDescriptor {
	return file_backend_api_v2beta1_run_proto_enumTypes[2].Descriptor()
}

func (PipelineTask_TaskPodType) Type() protoreflect.EnumType {
	return &file_backend_api_v2beta1_run_proto_enumTypes[2]
}

func (x PipelineTask_TaskPodType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PipelineTask_TaskPodType.Descriptor instead.
func (PipelineTask_TaskPodType) EnumDescriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_run_proto_rawDescGZIP(), []int{5, 0}
}

// Runtime state of a Task
type PipelineTask_TaskState int32

const (
	// Default value. This value is not used.
	PipelineTask_RUNTIME_STATE_UNSPECIFIED PipelineTask_TaskState = 0
	// Entity execution is in progress.
	PipelineTask_RUNNING PipelineTask_TaskState = 1
	// Entity completed successfully.
	PipelineTask_SUCCEEDED PipelineTask_TaskState = 2
	// Entity has been skipped. For example, due to caching.
	PipelineTask_SKIPPED PipelineTask_TaskState = 3
	// Entity execution has failed.
	PipelineTask_FAILED PipelineTask_TaskState = 4
	PipelineTask_CACHED PipelineTask_TaskState = 5
)

// Enum value maps for PipelineTask_TaskState.
var (
	PipelineTask_TaskState_name = map[int32]string{
		0: "RUNTIME_STATE_UNSPECIFIED",
		1: "RUNNING",
		2: "SUCCEEDED",
		3: "SKIPPED",
	...
	PipelineTask_TaskState_value = map[string]int32{
		"RUNTIME_STATE_UNSPECIFIED": 0,
		"RUNNING":                   1,
		"SUCCEEDED":                 2,
		"SKIPPED":                   3,
...
func (x PipelineTask_TaskState) Enum() *PipelineTask_TaskState {
	p := new(PipelineTask_TaskState)
	*p = x
	return p
}

func (x PipelineTask_TaskState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PipelineTask_TaskState) Descriptor() protoreflect.EnumDescriptor {
	return file_backend_api_v2beta1_run_proto_enumTypes[3].Descriptor()
}

func (PipelineTask_TaskState) Type() protoreflect.EnumType {
	return &file_backend_api_v2beta1_run_proto_enumTypes[3]
}

func (x PipelineTask_TaskState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PipelineTask_TaskState.Descriptor instead.
func (PipelineTask_TaskState) EnumDescriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_run_proto_rawDescGZIP(), []int{5, 1}
}

type PipelineTask_TaskType int32
...
const (
	...
	PipelineTask_ROOT PipelineTask_TaskType = 0
	...
	PipelineTask_RUNTIME PipelineTask_TaskType = 1
	// Condition Branch is the wrapper task of an If block
	PipelineTask_CONDITION_BRANCH PipelineTask_TaskType = 2
	// Condition is an individual "if" branch, and is
	// a child to a CONDITION_BRANCH task.
	PipelineTask_CONDITION PipelineTask_TaskType = 3
	// Task Group for CONDITION_BRANCH
	// Task Group for RUNTIME Loop Iterations
	PipelineTask_LOOP         PipelineTask_TaskType = 4
	PipelineTask_EXIT_HANDLER PipelineTask_TaskType = 5
	PipelineTask_IMPORTER     PipelineTask_TaskType = 6
	// Generic DAG task type for types like Nested Pipelines
	// where there is no declarative way to detect this within
	// a driver.
	PipelineTask_DAG PipelineTask_TaskType = 7
)

// Enum value maps for PipelineTask_TaskType.
var (
	PipelineTask_TaskType_name = map[int32]string{
		0: "ROOT",
		1: "RUNTIME",
		2: "CONDITION_BRANCH",
		3: "CONDITION",
	...
	PipelineTask_TaskType_value = map[string]int32{
		"ROOT":             0,
		"RUNTIME":          1,
		"CONDITION_BRANCH": 2,
		"CONDITION":        3,
...
func (x PipelineTask_TaskType) Enum() *PipelineTask_TaskType {
	p := new(PipelineTask_TaskType)
	*p = x
	return p
}

func (x PipelineTask_TaskType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PipelineTask_TaskType) Descriptor() protoreflect.EnumDescriptor {
	return file_backend_api_v2beta1_run_proto_enumTypes[4].Descriptor()
}

func (PipelineTask_TaskType) Type() protoreflect.EnumType {
	return &file_backend_api_v2beta1_run_proto_enumTypes[4]
}

func (x PipelineTask_TaskType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PipelineTask_TaskType.Descriptor instead.
func (PipelineTask_TaskType) EnumDescriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_run_proto_rawDescGZIP(), []int{5, 2}
}
...
func (ListRunsRequest_ViewMode) EnumDescriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_run_proto_rawDescGZIP(), []int{10, 0}
}
...
type Run struct {
	...
	// Deprecated: use Run.tasks and the task APIs instead.
	//
	...
	Tasks             []*PipelineTask           `protobuf:"bytes,21,rep,name=tasks,proto3" json:"tasks,omitempty"`
...
func (x *Run) GetTasks() []*PipelineTask {
	if x != nil {
		return x.Tasks
	}
	return nil
...
type RunDetails struct {
	...
	// This legacy field remains for backward compatibility only and
	// will be removed in the next major API version.
	//
	// Deprecated: Marked as deprecated in backend/api/v2beta1/run.proto.
...
// Deprecated: use PipelineTask instead.
...
type PipelineTask struct {
	...
	Pods             []*PipelineTask_TaskPod `protobuf:"bytes,5,rep,name=pods,proto3" json:"pods,omitempty"`
	...
	State          PipelineTask_TaskState       `protobuf:"varint,9,opt,name=state,proto3,enum=kubeflow.pipelines.backend.api.v2beta1.PipelineTask_TaskState" json:"state,omitempty"`
	StatusMetadata *PipelineTask_StatusMetadata `protobuf:"bytes,10,opt,name=status_metadata,json=statusMetadata,proto3" json:"status_metadata,omitempty"`
	// A sequence of task statuses. This field keeps a record
	// of state transitions.
	StateHistory   []*PipelineTask_TaskStatus   `protobuf:"bytes,11,rep,name=state_history,json=stateHistory,proto3" json:"state_history,omitempty"`
	Type           PipelineTask_TaskType        `protobuf:"varint,12,opt,name=type,proto3,enum=kubeflow.pipelines.backend.api.v2beta1.PipelineTask_TaskType" json:"type,omitempty"`
	TypeAttributes *PipelineTask_TypeAttributes `protobuf:"bytes,13,opt,name=type_attributes,json=typeAttributes,proto3" json:"type_attributes,omitempty"`
	// The error that occurred during task execution.
	// Only populated when the task is in FAILED or CANCELED state.
	Error *status.Status `protobuf:"bytes,14,opt,name=error,proto3" json:"error,omitempty"`
	// ID of the parent task if the task is within a component scope.
	...
	// Sequence of dependent tasks.
	ChildTasks []*PipelineTask_ChildTask  `protobuf:"bytes,16,rep,name=child_tasks,json=childTasks,proto3" json:"child_tasks,omitempty"`
	Inputs     *PipelineTask_InputOutputs `protobuf:"bytes,17,opt,name=inputs,proto3" json:"inputs,omitempty"`
	Outputs    *PipelineTask_InputOutputs `protobuf:"bytes,18,opt,name=outputs,proto3" json:"outputs,omitempty"`
...
func (x *PipelineTask) GetDisplayName() string {
	if x != nil {
		return x.DisplayName
	}
	return ""
...
func (x *PipelineTask) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *PipelineTask) GetRunId() string {
	if x != nil {
		return x.RunId
	}
	return ""
...
func (x *PipelineTask) GetPods() []*PipelineTask_TaskPod {
	if x != nil {
		return x.Pods
	}
	return nil
...
func (x *PipelineTask) GetCacheFingerprint() string {
	if x != nil {
...
func (x *PipelineTask) GetCreateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *PipelineTask) GetEndTime() *timestamppb.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
...
func (x *PipelineTask) GetState() PipelineTask_TaskState {
	if x != nil {
		return x.State
	}
	return PipelineTask_RUNTIME_STATE_UNSPECIFIED
}

func (x *PipelineTask) GetStatusMetadata() *PipelineTask_StatusMetadata {
	if x != nil {
...
func (x *PipelineTask) GetStateHistory() []*PipelineTask_TaskStatus {
	if x != nil {
		return x.StateHistory
	}
	return nil
...
func (x *PipelineTask) GetType() PipelineTask_TaskType {
	if x != nil {
		return x.Type
	}
	return PipelineTask_ROOT
}

func (x *PipelineTask) GetTypeAttributes() *PipelineTask_TypeAttributes {
	if x != nil {
...
func (x *PipelineTask) GetError() *status.Status {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *PipelineTask) GetParentTaskId() string {
...
func (x *PipelineTask) GetChildTasks() []*PipelineTask_ChildTask {
	if x != nil {
		return x.ChildTasks
	}
	return nil
...
func (x *PipelineTask) GetInputs() *PipelineTask_InputOutputs {
	if x != nil {
		return x.Inputs
	}
	return nil
...
func (x *PipelineTask) GetOutputs() *PipelineTask_InputOutputs {
	if x != nil {
		return x.Outputs
	}
	return nil
...
type CreateTaskRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Task          *PipelineTask          `protobuf:"bytes,1,opt,name=task,proto3" json:"task,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateTaskRequest) GetTask() *PipelineTask {
	if x != nil {
		return x.Task
	}
	return nil
...
type UpdateTaskRequest struct {
	...
	Task          *PipelineTask          `protobuf:"bytes,2,opt,name=task,proto3" json:"task,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateTaskRequest) GetTask() *PipelineTask {
	if x != nil {
		return x.Task
	}
	return nil
...
type UpdateTasksBulkRequest struct {
	...
	Tasks         map[string]*PipelineTask `protobuf:"bytes,1,rep,name=tasks,proto3" json:"tasks,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateTasksBulkRequest) GetTasks() map[string]*PipelineTask {
	if x != nil {
		return x.Tasks
	}
	return nil
...
type UpdateTasksBulkResponse struct {
	...
	// Key: task_id, Value: Updated PipelineTask
	Tasks         map[string]*PipelineTask `protobuf:"bytes,1,rep,name=tasks,proto3" json:"tasks,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateTasksBulkResponse) GetTasks() map[string]*PipelineTask {
	if x != nil {
		return x.Tasks
	}
	return nil
...
type ListTasksResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tasks         []*PipelineTask        `protobuf:"bytes,1,rep,name=tasks,proto3" json:"tasks,omitempty"`
...
func (x *ListTasksResponse) GetTasks() []*PipelineTask {
	if x != nil {
		return x.Tasks
	}
	return nil
...
type PipelineTask_TaskPod struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Name          string                   `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Uid           string                   `protobuf:"bytes,2,opt,name=uid,proto3" json:"uid,omitempty"`
	Type          PipelineTask_TaskPodType `protobuf:"varint,3,opt,name=type,proto3,enum=kubeflow.pipelines.backend.api.v2beta1.PipelineTask_TaskPodType" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PipelineTask_TaskPod) Reset() {
	*x = PipelineTask_TaskPod{}
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PipelineTask_TaskPod) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PipelineTask_TaskPod) ProtoMessage() {}

func (x *PipelineTask_TaskPod) ProtoReflect() protoreflect.Message {
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PipelineTask_TaskPod.ProtoReflect.Descriptor instead.
func (*PipelineTask_TaskPod) Descriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_run_proto_rawDescGZIP(), []int{5, 0}
}

func (x *PipelineTask_TaskPod) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PipelineTask_TaskPod) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
func (x *PipelineTask_TaskPod) GetType() PipelineTask_TaskPodType {
	if x != nil {
		return x.Type
	}
	return PipelineTask_UNSPECIFIED
}

type PipelineTask_StatusMetadata struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PipelineTask_StatusMetadata) Reset() {
	*x = PipelineTask_StatusMetadata{}
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PipelineTask_StatusMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PipelineTask_StatusMetadata) ProtoMessage() {}

func (x *PipelineTask_StatusMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[28]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PipelineTask_StatusMetadata.ProtoReflect.Descriptor instead.
func (*PipelineTask_StatusMetadata) Descriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_run_proto_rawDescGZIP(), []int{5, 1}
}

func (x *PipelineTask_StatusMetadata) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *PipelineTask_StatusMetadata) GetCustomProperties() map[string]*structpb.Value {
	if x != nil {
...
type PipelineTask_TaskStatus struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UpdateTime    *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`
	State         PipelineTask_TaskState `protobuf:"varint,2,opt,name=state,proto3,enum=kubeflow.pipelines.backend.api.v2beta1.PipelineTask_TaskState" json:"state,omitempty"`
	Error         *status.Status         `protobuf:"bytes,3,opt,name=error,proto3" json:"error,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PipelineTask_TaskStatus) Reset() {
	*x = PipelineTask_TaskStatus{}
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PipelineTask_TaskStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PipelineTask_TaskStatus) ProtoMessage() {}

func (x *PipelineTask_TaskStatus) ProtoReflect() protoreflect.Message {
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[29]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PipelineTask_TaskStatus.ProtoReflect.Descriptor instead.
func (*PipelineTask_TaskStatus) Descriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_run_proto_rawDescGZIP(), []int{5, 2}
}

func (x *PipelineTask_TaskStatus) GetUpdateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *PipelineTask_TaskStatus) GetState() PipelineTask_TaskState {
	if x != nil {
		return x.State
	}
	return PipelineTask_RUNTIME_STATE_UNSPECIFIED
...
func (x *PipelineTask_TaskStatus) GetError() *status.Status {
	if x != nil {
		return x.Error
	}
	return nil
...
type PipelineTask_TypeAttributes struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PipelineTask_TypeAttributes) Reset() {
	*x = PipelineTask_TypeAttributes{}
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PipelineTask_TypeAttributes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PipelineTask_TypeAttributes) ProtoMessage() {}

func (x *PipelineTask_TypeAttributes) ProtoReflect() protoreflect.Message {
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[30]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PipelineTask_TypeAttributes.ProtoReflect.Descriptor instead.
func (*PipelineTask_TypeAttributes) Descriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_run_proto_rawDescGZIP(), []int{5, 3}
}

func (x *PipelineTask_TypeAttributes) GetIterationIndex() int64 {
...
func (x *PipelineTask_TypeAttributes) GetIterationCount() int64 {
...
func (x *PipelineTask_TypeAttributes) GetDownloadToWorkspace() bool {
...
type PipelineTask_ChildTask struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// System-generated ID of a task.
	TaskId        string `protobuf:"bytes,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
...
func (x *PipelineTask_ChildTask) Reset() {
	*x = PipelineTask_ChildTask{}
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PipelineTask_ChildTask) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PipelineTask_ChildTask) ProtoMessage() {}

func (x *PipelineTask_ChildTask) ProtoReflect() protoreflect.Message {
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[31]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PipelineTask_ChildTask.ProtoReflect.Descriptor instead.
func (*PipelineTask_ChildTask) Descriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_run_proto_rawDescGZIP(), []int{5, 4}
}

func (x *PipelineTask_ChildTask) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *PipelineTask_ChildTask) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type PipelineTask_InputOutputs struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// For Loops parameters are filled with resolved
	// parameterIterator.items
	Parameters []*PipelineTask_InputOutputs_IOParameter `protobuf:"bytes,1,rep,name=parameters,proto3" json:"parameters,omitempty"`
	// Output Only. To create Artifacts for a task use
	// ArtifactTasks to link artifacts to tasks.
	Artifacts     []*PipelineTask_InputOutputs_IOArtifact `protobuf:"bytes,2,rep,name=artifacts,proto3" json:"artifacts,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PipelineTask_InputOutputs) Reset() {
	*x = PipelineTask_InputOutputs{}
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PipelineTask_InputOutputs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PipelineTask_InputOutputs) ProtoMessage() {}

func (x *PipelineTask_InputOutputs) ProtoReflect() protoreflect.Message {
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PipelineTask_InputOutputs.ProtoReflect.Descriptor instead.
func (*PipelineTask_InputOutputs) Descriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_run_proto_rawDescGZIP(), []int{5, 5}
}

func (x *PipelineTask_InputOutputs) GetParameters() []*PipelineTask_InputOutputs_IOParameter {
	if x != nil {
		return x.Parameters
	}
	return nil
...
func (x *PipelineTask_InputOutputs) GetArtifacts() []*PipelineTask_InputOutputs_IOArtifact {
	if x != nil {
		return x.Artifacts
	}
	return nil
...
type PipelineTask_InputOutputs_IOParameter struct {
	state        protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PipelineTask_InputOutputs_IOParameter) Reset() {
	*x = PipelineTask_InputOutputs_IOParameter{}
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PipelineTask_InputOutputs_IOParameter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PipelineTask_InputOutputs_IOParameter) ProtoMessage() {}

func (x *PipelineTask_InputOutputs_IOParameter) ProtoReflect() protoreflect.Message {
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PipelineTask_InputOutputs_IOParameter.ProtoReflect.Descriptor instead.
func (*PipelineTask_InputOutputs_IOParameter) Descriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_run_proto_rawDescGZIP(), []int{5, 5, 0}
}

func (x *PipelineTask_InputOutputs_IOParameter) GetValue() *structpb.Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *PipelineTask_InputOutputs_IOParameter) GetType() IOType {
	if x != nil {
		return x.Type
	}
...
func (x *PipelineTask_InputOutputs_IOParameter) GetParameterKey() string {
	if x != nil {
...
func (x *PipelineTask_InputOutputs_IOParameter) GetProducer() *IOProducer {
	if x != nil {
		return x.Producer
	}
	return nil
...
type PipelineTask_InputOutputs_IOArtifact struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PipelineTask_InputOutputs_IOArtifact) Reset() {
	*x = PipelineTask_InputOutputs_IOArtifact{}
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PipelineTask_InputOutputs_IOArtifact) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PipelineTask_InputOutputs_IOArtifact) ProtoMessage() {}

func (x *PipelineTask_InputOutputs_IOArtifact) ProtoReflect() protoreflect.Message {
	mi := &file_backend_api_v2beta1_run_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PipelineTask_InputOutputs_IOArtifact.ProtoReflect.Descriptor instead.
func (*PipelineTask_InputOutputs_IOArtifact) Descriptor() ([]byte, []int) {
	return file_backend_api_v2beta1_run_proto_rawDescGZIP(), []int{5, 5, 1}
}

func (x *PipelineTask_InputOutputs_IOArtifact) GetArtifacts() []*Artifact {
	if x != nil {
		return x.Artifacts
	}
	return nil
...
func (x *PipelineTask_InputOutputs_IOArtifact) GetType() IOType {
	if x != nil {
		return x.Type
	}
	return IOType_UNSPECIFIED
...
func (x *PipelineTask_InputOutputs_IOArtifact) GetArtifactKey() string {
	if x != nil {
...
func (x *PipelineTask_InputOutputs_IOArtifact) GetProducer() *IOProducer {
	if x != nil {
		return x.Producer
	}
	return nil
...
const file_backend_api_v2beta1_run_proto_rawDesc = "" +
	...
	"\n" +
	"task_count\x18\x14 \x01(\x05R\ttaskCount\x12J\n" +
	"\x05tasks\x18\x15 \x03(\v24.kubeflow.pipelines.backend.api.v2beta1.PipelineTaskR\x05tasks\"J\n" +
	...
	"\x05error\x18\x03 \x01(\v2\x12.google.rpc.StatusR\x05error\"\xd6\x01\n" +
	"\n" +
	"RunDetails\x12.\n" +
	"\x13pipeline_context_id\x18\x01 \x01(\x03R\x11pipelineContextId\x125\n" +
	"\x17pipeline_run_context_id\x18\x02 \x01(\x03R\x14pipelineRunContextId\x12a\n" +
	"\ftask_details\x18\x03 \x03(\v2:.kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetailB\x02\x18\x01R\vtaskDetails\"\x87\n" +
	"\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12J\n" +
	"\x05value\x18\x02 \x01(\v24.kubeflow.pipelines.backend.api.v2beta1.ArtifactListR\x05value:\x028\x01\x1a?\n" +
	"\tChildTask\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12\x19\n" +
	"\bpod_name\x18\x02 \x01(\tR\apodName\"\xab\x19\n" +
	...
	"\x04pods\x18\x05 \x03(\v2<.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskPodR\x04pods\x12+\n" +
	"\x11cache_fingerprint\x18\x06 \x01(\tR\x10cacheFingerprint\x12;\n" +
	"\vcreate_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x125\n" +
	"\bend_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x12T\n" +
	"\x05state\x18\t \x01(\x0e2>.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskStateR\x05state\x12l\n" +
	"\x0fstatus_metadata\x18\n" +
	" \x01(\v2C.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.StatusMetadataR\x0estatusMetadata\x12d\n" +
	"\rstate_history\x18\v \x03(\v2?.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskStatusR\fstateHistory\x12Q\n" +
	"\x04type\x18\f \x01(\x0e2=.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskTypeR\x04type\x12l\n" +
	"\x0ftype_attributes\x18\r \x01(\v2C.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TypeAttributesR\x0etypeAttributes\x12(\n" +
	"\x05error\x18\x0e \x01(\v2\x12.google.rpc.StatusR\x05error\x12)\n" +
	"\x0eparent_task_id\x18\x0f \x01(\tH\x00R\fparentTaskId\x88\x01\x01\x12_\n" +
	"\vchild_tasks\x18\x10 \x03(\v2>.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.ChildTaskR\n" +
	"childTasks\x12Y\n" +
	"\x06inputs\x18\x11 \x01(\v2A.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputsR\x06inputs\x12[\n" +
	"\aoutputs\x18\x12 \x01(\v2A.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputsR\aoutputs\x12\x1d\n" +
	"\n" +
	"scope_path\x18\x13 \x01(\tR\tscopePath\x1a\x85\x01\n" +
	"\aTaskPod\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n" +
	"\x03uid\x18\x02 \x01(\tR\x03uid\x12T\n" +
	"\x04type\x18\x03 \x01(\x0e2@.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskPodTypeR\x04type\x1a\x90\x02\n" +
	"\x0eStatusMetadata\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x86\x01\n" +
	"\x11custom_properties\x18\x02 \x03(\v2Y.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.StatusMetadata.CustomPropertiesEntryR\x10customProperties\x1a[\n" +
	"\x15CustomPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x01\x1a\xc9\x01\n" +
	"\n" +
	"TaskStatus\x12;\n" +
	"\vupdate_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\x12T\n" +
	"\x05state\x18\x02 \x01(\x0e2>.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskStateR\x05state\x12(\n" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name\x1a\x88\x06\n" +
	"\fInputOutputs\x12m\n" +
	"\n" +
	"parameters\x18\x01 \x03(\v2M.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.IOParameterR\n" +
	"parameters\x12j\n" +
	"\tartifacts\x18\x02 \x03(\v2L.kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.IOArtifactR\tartifacts\x1a\x86\x02\n" +
	"\vIOParameter\x12,\n" +
	...
	"\x04task\x18\x01 \x01(\v24.kubeflow.pipelines.backend.api.v2beta1.PipelineTaskR\x04task\"v\n" +
	"\x11UpdateTaskRequest\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12H\n" +
	"\x04task\x18\x02 \x01(\v24.kubeflow.pipelines.backend.api.v2beta1.PipelineTaskR\x04task\"\xe9\x01\n" +
	"\x16UpdateTasksBulkRequest\x12_\n" +
	"\x05tasks\x18\x01 \x03(\v2I.kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkRequest.TasksEntryR\x05tasks\x1an\n" +
	"\n" +
	"TasksEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12J\n" +
	"\x05value\x18\x02 \x01(\v24.kubeflow.pipelines.backend.api.v2beta1.PipelineTaskR\x05value:\x028\x01\"\xeb\x01\n" +
	"\x17UpdateTasksBulkResponse\x12`\n" +
	"\x05tasks\x18\x01 \x03(\v2J.kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkResponse.TasksEntryR\x05tasks\x1an\n" +
	"\n" +
	"TasksEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12J\n" +
	"\x05value\x18\x02 \x01(\v24.kubeflow.pipelines.backend.api.v2beta1.PipelineTaskR\x05value:\x028\x01\")\n" +
	...
	"\rparent_filter\"\xa6\x01\n" +
	"\x11ListTasksResponse\x12J\n" +
	"\x05tasks\x18\x01 \x03(\v24.kubeflow.pipelines.backend.api.v2beta1.PipelineTaskR\x05tasks\x12&\n" +
	...
	"\bRetryRun\x127.kubeflow.pipelines.backend.api.v2beta1.RetryRunRequest\x1a\x16.google.protobuf.Empty\")\x82\xd3\xe4\x93\x02#\"!/apis/v2beta1/runs/{run_id}:retry\x12\xd1\x01\n" +
	"\n" +
	"CreateTask\x129.kubeflow.pipelines.backend.api.v2beta1.CreateTaskRequest\x1a4.kubeflow.pipelines.backend.api.v2beta1.PipelineTask\"R\x92A.\n" +
	"\n" +
	"RunService\x12\x13Creates a new task.*\vcreate_task\x82\xd3\xe4\x93\x02\x1b:\x04task\"\x13/apis/v2beta1/tasks\x12\xe1\x01\n" +
	"\n" +
	"UpdateTask\x129.kubeflow.pipelines.backend.api.v2beta1.UpdateTaskRequest\x1a4.kubeflow.pipelines.backend.api.v2beta1.PipelineTask\"b\x92A4\n" +
	"\n" +
	...
	"\n" +
	"RunService\x12\x1fUpdates multiple tasks in bulk.*\x12batch_update_tasks\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/apis/v2beta1/tasks:batchUpdate\x12\xd4\x01\n" +
	"\aGetTask\x126.kubeflow.pipelines.backend.api.v2beta1.GetTaskRequest\x1a4.kubeflow.pipelines.backend.api.v2beta1.PipelineTask\"[\x92A3\n" +
	"\n" +
...
var file_backend_api_v2beta1_run_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_backend_api_v2beta1_run_proto_goTypes = []any{
	...
	(PipelineTask_TaskPodType)(0),                 // 2: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskPodType
	(PipelineTask_TaskState)(0),                   // 3: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskState
	(PipelineTask_TaskType)(0),                    // 4: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskType
	...
	(*PipelineTask)(nil),                          // 12: kubeflow.pipelines.backend.api.v2beta1.PipelineTask
	(*PipelineTaskExecutorDetail)(nil),            // 13: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskExecutorDetail
	(*ArtifactList)(nil),                          // 14: kubeflow.pipelines.backend.api.v2beta1.ArtifactList
	(*CreateRunRequest)(nil),                      // 15: kubeflow.pipelines.backend.api.v2beta1.CreateRunRequest
	(*GetRunRequest)(nil),                         // 16: kubeflow.pipelines.backend.api.v2beta1.GetRunRequest
	(*ListRunsRequest)(nil),                       // 17: kubeflow.pipelines.backend.api.v2beta1.ListRunsRequest
	(*TerminateRunRequest)(nil),                   // 18: kubeflow.pipelines.backend.api.v2beta1.TerminateRunRequest
	(*ListRunsResponse)(nil),                      // 19: kubeflow.pipelines.backend.api.v2beta1.ListRunsResponse
	(*ArchiveRunRequest)(nil),                     // 20: kubeflow.pipelines.backend.api.v2beta1.ArchiveRunRequest
	(*UnarchiveRunRequest)(nil),                   // 21: kubeflow.pipelines.backend.api.v2beta1.UnarchiveRunRequest
	(*DeleteRunRequest)(nil),                      // 22: kubeflow.pipelines.backend.api.v2beta1.DeleteRunRequest
	(*RetryRunRequest)(nil),                       // 23: kubeflow.pipelines.backend.api.v2beta1.RetryRunRequest
	(*CreateTaskRequest)(nil),                     // 24: kubeflow.pipelines.backend.api.v2beta1.CreateTaskRequest
	(*UpdateTaskRequest)(nil),                     // 25: kubeflow.pipelines.backend.api.v2beta1.UpdateTaskRequest
	(*UpdateTasksBulkRequest)(nil),                // 26: kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkRequest
	(*UpdateTasksBulkResponse)(nil),               // 27: kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkResponse
	(*GetTaskRequest)(nil),                        // 28: kubeflow.pipelines.backend.api.v2beta1.GetTaskRequest
	(*ListTasksRequest)(nil),                      // 29: kubeflow.pipelines.backend.api.v2beta1.ListTasksRequest
	(*ListTasksResponse)(nil),                     // 30: kubeflow.pipelines.backend.api.v2beta1.ListTasksResponse
	nil,                                           // 31: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.InputsEntry
	nil,                                           // 32: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.OutputsEntry
	(*PipelineTaskDetail_ChildTask)(nil),          // 33: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.ChildTask
	(*PipelineTask_TaskPod)(nil),                  // 34: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskPod
	(*PipelineTask_StatusMetadata)(nil),           // 35: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.StatusMetadata
	(*PipelineTask_TaskStatus)(nil),               // 36: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskStatus
	(*PipelineTask_TypeAttributes)(nil),           // 37: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TypeAttributes
	(*PipelineTask_ChildTask)(nil),                // 38: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.ChildTask
	(*PipelineTask_InputOutputs)(nil),             // 39: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs
	nil,                                           // 40: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.StatusMetadata.CustomPropertiesEntry
	(*PipelineTask_InputOutputs_IOParameter)(nil), // 41: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.IOParameter
	(*PipelineTask_InputOutputs_IOArtifact)(nil),  // 42: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.IOArtifact
	nil,                           // 43: kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkRequest.TasksEntry
	nil,                           // 44: kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkResponse.TasksEntry
	(*structpb.Struct)(nil),       // 45: google.protobuf.Struct
	(*RuntimeConfig)(nil),         // 46: kubeflow.pipelines.backend.api.v2beta1.RuntimeConfig
	(*timestamppb.Timestamp)(nil), // 47: google.protobuf.Timestamp
	(*status.Status)(nil),         // 48: google.rpc.Status
	(*structpb.Value)(nil),        // 49: google.protobuf.Value
	(IOType)(0),                   // 50: kubeflow.pipelines.backend.api.v2beta1.IOType
	(*IOProducer)(nil),            // 51: kubeflow.pipelines.backend.api.v2beta1.IOProducer
	(*Artifact)(nil),              // 52: kubeflow.pipelines.backend.api.v2beta1.Artifact
...
var file_backend_api_v2beta1_run_proto_depIdxs = []int32{
	...
	45, // 1: kubeflow.pipelines.backend.api.v2beta1.Run.pipeline_spec:type_name -> google.protobuf.Struct
	...
	46, // 3: kubeflow.pipelines.backend.api.v2beta1.Run.runtime_config:type_name -> kubeflow.pipelines.backend.api.v2beta1.RuntimeConfig
	47, // 4: kubeflow.pipelines.backend.api.v2beta1.Run.created_at:type_name -> google.protobuf.Timestamp
	47, // 5: kubeflow.pipelines.backend.api.v2beta1.Run.scheduled_at:type_name -> google.protobuf.Timestamp
	47, // 6: kubeflow.pipelines.backend.api.v2beta1.Run.finished_at:type_name -> google.protobuf.Timestamp
	0,  // 7: kubeflow.pipelines.backend.api.v2beta1.Run.state:type_name -> kubeflow.pipelines.backend.api.v2beta1.RuntimeState
	48, // 8: kubeflow.pipelines.backend.api.v2beta1.Run.error:type_name -> google.rpc.Status
	...
	12, // 12: kubeflow.pipelines.backend.api.v2beta1.Run.tasks:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask
	47, // 13: kubeflow.pipelines.backend.api.v2beta1.RuntimeStatus.update_time:type_name -> google.protobuf.Timestamp
	...
	48, // 15: kubeflow.pipelines.backend.api.v2beta1.RuntimeStatus.error:type_name -> google.rpc.Status
	...
	47, // 17: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.create_time:type_name -> google.protobuf.Timestamp
	47, // 18: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.start_time:type_name -> google.protobuf.Timestamp
	47, // 19: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.end_time:type_name -> google.protobuf.Timestamp
	13, // 20: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.executor_detail:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTaskExecutorDetail
	0,  // 21: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.state:type_name -> kubeflow.pipelines.backend.api.v2beta1.RuntimeState
	48, // 22: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.error:type_name -> google.rpc.Status
	31, // 23: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.inputs:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.InputsEntry
	32, // 24: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.outputs:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.OutputsEntry
	9,  // 25: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.state_history:type_name -> kubeflow.pipelines.backend.api.v2beta1.RuntimeStatus
	33, // 26: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.child_tasks:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.ChildTask
	34, // 27: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.pods:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskPod
	47, // 28: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.create_time:type_name -> google.protobuf.Timestamp
	47, // 29: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.end_time:type_name -> google.protobuf.Timestamp
	3,  // 30: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.state:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskState
	35, // 31: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.status_metadata:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.StatusMetadata
	36, // 32: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.state_history:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskStatus
	4,  // 33: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.type:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskType
	37, // 34: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.type_attributes:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TypeAttributes
	48, // 35: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.error:type_name -> google.rpc.Status
	38, // 36: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.child_tasks:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.ChildTask
	39, // 37: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.inputs:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs
	39, // 38: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.outputs:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs
	7,  // 39: kubeflow.pipelines.backend.api.v2beta1.CreateRunRequest.run:type_name -> kubeflow.pipelines.backend.api.v2beta1.Run
	5,  // 40: kubeflow.pipelines.backend.api.v2beta1.GetRunRequest.view:type_name -> kubeflow.pipelines.backend.api.v2beta1.GetRunRequest.ViewMode
	6,  // 41: kubeflow.pipelines.backend.api.v2beta1.ListRunsRequest.view:type_name -> kubeflow.pipelines.backend.api.v2beta1.ListRunsRequest.ViewMode
	7,  // 42: kubeflow.pipelines.backend.api.v2beta1.ListRunsResponse.runs:type_name -> kubeflow.pipelines.backend.api.v2beta1.Run
	12, // 43: kubeflow.pipelines.backend.api.v2beta1.CreateTaskRequest.task:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask
	12, // 44: kubeflow.pipelines.backend.api.v2beta1.UpdateTaskRequest.task:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask
	43, // 45: kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkRequest.tasks:type_name -> kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkRequest.TasksEntry
	44, // 46: kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkResponse.tasks:type_name -> kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkResponse.TasksEntry
	12, // 47: kubeflow.pipelines.backend.api.v2beta1.ListTasksResponse.tasks:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask
	14, // 48: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.InputsEntry.value:type_name -> kubeflow.pipelines.backend.api.v2beta1.ArtifactList
	14, // 49: kubeflow.pipelines.backend.api.v2beta1.PipelineTaskDetail.OutputsEntry.value:type_name -> kubeflow.pipelines.backend.api.v2beta1.ArtifactList
	2,  // 50: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskPod.type:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskPodType
	40, // 51: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.StatusMetadata.custom_properties:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.StatusMetadata.CustomPropertiesEntry
	47, // 52: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskStatus.update_time:type_name -> google.protobuf.Timestamp
	3,  // 53: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskStatus.state:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskState
	48, // 54: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.TaskStatus.error:type_name -> google.rpc.Status
	41, // 55: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.parameters:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.IOParameter
	42, // 56: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.artifacts:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.IOArtifact
	49, // 57: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.StatusMetadata.CustomPropertiesEntry.value:type_name -> google.protobuf.Value
	49, // 58: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.IOParameter.value:type_name -> google.protobuf.Value
	50, // 59: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.IOParameter.type:type_name -> kubeflow.pipelines.backend.api.v2beta1.IOType
	51, // 60: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.IOParameter.producer:type_name -> kubeflow.pipelines.backend.api.v2beta1.IOProducer
	52, // 61: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.IOArtifact.artifacts:type_name -> kubeflow.pipelines.backend.api.v2beta1.Artifact
	50, // 62: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.IOArtifact.type:type_name -> kubeflow.pipelines.backend.api.v2beta1.IOType
	51, // 63: kubeflow.pipelines.backend.api.v2beta1.PipelineTask.InputOutputs.IOArtifact.producer:type_name -> kubeflow.pipelines.backend.api.v2beta1.IOProducer
	12, // 64: kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkRequest.TasksEntry.value:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask
	12, // 65: kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkResponse.TasksEntry.value:type_name -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask
	15, // 66: kubeflow.pipelines.backend.api.v2beta1.RunService.CreateRun:input_type -> kubeflow.pipelines.backend.api.v2beta1.CreateRunRequest
	16, // 67: kubeflow.pipelines.backend.api.v2beta1.RunService.GetRun:input_type -> kubeflow.pipelines.backend.api.v2beta1.GetRunRequest
	17, // 68: kubeflow.pipelines.backend.api.v2beta1.RunService.ListRuns:input_type -> kubeflow.pipelines.backend.api.v2beta1.ListRunsRequest
	20, // 69: kubeflow.pipelines.backend.api.v2beta1.RunService.ArchiveRun:input_type -> kubeflow.pipelines.backend.api.v2beta1.ArchiveRunRequest
	21, // 70: kubeflow.pipelines.backend.api.v2beta1.RunService.UnarchiveRun:input_type -> kubeflow.pipelines.backend.api.v2beta1.UnarchiveRunRequest
	22, // 71: kubeflow.pipelines.backend.api.v2beta1.RunService.DeleteRun:input_type -> kubeflow.pipelines.backend.api.v2beta1.DeleteRunRequest
	18, // 72: kubeflow.pipelines.backend.api.v2beta1.RunService.TerminateRun:input_type -> kubeflow.pipelines.backend.api.v2beta1.TerminateRunRequest
	23, // 73: kubeflow.pipelines.backend.api.v2beta1.RunService.RetryRun:input_type -> kubeflow.pipelines.backend.api.v2beta1.RetryRunRequest
	24, // 74: kubeflow.pipelines.backend.api.v2beta1.RunService.CreateTask:input_type -> kubeflow.pipelines.backend.api.v2beta1.CreateTaskRequest
	25, // 75: kubeflow.pipelines.backend.api.v2beta1.RunService.UpdateTask:input_type -> kubeflow.pipelines.backend.api.v2beta1.UpdateTaskRequest
	26, // 76: kubeflow.pipelines.backend.api.v2beta1.RunService.UpdateTasksBulk:input_type -> kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkRequest
	28, // 77: kubeflow.pipelines.backend.api.v2beta1.RunService.GetTask:input_type -> kubeflow.pipelines.backend.api.v2beta1.GetTaskRequest
	29, // 78: kubeflow.pipelines.backend.api.v2beta1.RunService.ListTasks:input_type -> kubeflow.pipelines.backend.api.v2beta1.ListTasksRequest
	7,  // 79: kubeflow.pipelines.backend.api.v2beta1.RunService.CreateRun:output_type -> kubeflow.pipelines.backend.api.v2beta1.Run
	7,  // 80: kubeflow.pipelines.backend.api.v2beta1.RunService.GetRun:output_type -> kubeflow.pipelines.backend.api.v2beta1.Run
	19, // 81: kubeflow.pipelines.backend.api.v2beta1.RunService.ListRuns:output_type -> kubeflow.pipelines.backend.api.v2beta1.ListRunsResponse
	53, // 82: kubeflow.pipelines.backend.api.v2beta1.RunService.ArchiveRun:output_type -> google.protobuf.Empty
	53, // 83: kubeflow.pipelines.backend.api.v2beta1.RunService.UnarchiveRun:output_type -> google.protobuf.Empty
	53, // 84: kubeflow.pipelines.backend.api.v2beta1.RunService.DeleteRun:output_type -> google.protobuf.Empty
	53, // 85: kubeflow.pipelines.backend.api.v2beta1.RunService.TerminateRun:output_type -> google.protobuf.Empty
	53, // 86: kubeflow.pipelines.backend.api.v2beta1.RunService.RetryRun:output_type -> google.protobuf.Empty
	12, // 87: kubeflow.pipelines.backend.api.v2beta1.RunService.CreateTask:output_type -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask
	12, // 88: kubeflow.pipelines.backend.api.v2beta1.RunService.UpdateTask:output_type -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask
	27, // 89: kubeflow.pipelines.backend.api.v2beta1.RunService.UpdateTasksBulk:output_type -> kubeflow.pipelines.backend.api.v2beta1.UpdateTasksBulkResponse
	12, // 90: kubeflow.pipelines.backend.api.v2beta1.RunService.GetTask:output_type -> kubeflow.pipelines.backend.api.v2beta1.PipelineTask
	30, // 91: kubeflow.pipelines.backend.api.v2beta1.RunService.ListTasks:output_type -> kubeflow.pipelines.backend.api.v2beta1.ListTasksResponse
...
func file_backend_api_v2beta1_run_proto_init() {
	...
	file_backend_api_v2beta1_run_proto_msgTypes[5].OneofWrappers = []any{}
	file_backend_api_v2beta1_run_proto_msgTypes[9].OneofWrappers = []any{}
	file_backend_api_v2beta1_run_proto_msgTypes[10].OneofWrappers = []any{}
	file_backend_api_v2beta1_run_proto_msgTypes[22].OneofWrappers = []any{
	...
	file_backend_api_v2beta1_run_proto_msgTypes[34].OneofWrappers = []any{}
	type x struct{}
