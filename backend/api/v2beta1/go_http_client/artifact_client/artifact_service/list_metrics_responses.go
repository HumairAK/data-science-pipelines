...
func (o *ListMetricsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apis/v2beta1/metrics][%d] list_metrics default %s", o._statusCode, payload)
}
...
func (o *ListMetricsDefault) GetPayload() *artifact_model.GooglerpcStatus {
	return o.Payload
}
