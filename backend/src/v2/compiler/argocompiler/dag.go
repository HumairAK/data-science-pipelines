...
func (c *workflowCompiler) addDAGDriverTemplate() string {
	...
	parameters := []wfapi.Parameter{
		...
		{Name: "dag_execution_id", Value: wfapi.AnyStringPtr(inputValue(paramParentDagID))},
		{Name: "component", Value: wfapi.AnyStringPtr(inputValue(paramComponent))},
		{Name: "task", Value: wfapi.AnyStringPtr(inputValue(paramTask))},
		{Name: "runtime_config", Value: wfapi.AnyStringPtr(inputValue(paramRuntimeConfig))},
		{Name: "iteration_index", Value: wfapi.AnyStringPtr(inputValue(paramIterationIndex))},
		{Name: "execution_id_path", Value: wfapi.AnyStringPtr(outputPath(paramExecutionID))},
		{Name: "iteration_count_path", Value: wfapi.AnyStringPtr(outputPath(paramIterationCount))},
		{Name: "condition_path", Value: wfapi.AnyStringPtr(outputPath(paramCondition))},
