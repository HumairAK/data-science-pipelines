...
func NewJobClient(clientConfig clientcmd.ClientConfig, debug bool, tlsEnabled bool) (
	*JobClient, error) {
...
func NewKubeflowInClusterJobClient(namespace string, debug bool, tlsEnabled bool) (
	*JobClient, error) {
