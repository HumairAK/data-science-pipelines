...
func NewVisualizationClient(clientConfig clientcmd.ClientConfig, debug bool, tlsEnabled bool) (
...
func NewKubeflowInClusterVisualizationClient(namespace string, debug bool, tlsEnabled bool) (
	*VisualizationClient, error) {
