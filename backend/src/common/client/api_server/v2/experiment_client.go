...
func NewExperimentClient(clientConfig clientcmd.ClientConfig, debug bool, tlsEnabled bool) (
...
func NewKubeflowInClusterExperimentClient(namespace string, debug bool, tlsEnabled bool) (
	*ExperimentClient, error) {
