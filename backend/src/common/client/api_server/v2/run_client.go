...
func NewRunClient(clientConfig clientcmd.ClientConfig, debug bool, tlsEnabled bool) (
	*RunClient, error) {
...
func NewKubeflowInClusterRunClient(namespace string, debug bool, tlsEnabled bool) (
	*RunClient, error) {
