...
func NewRecurringRunClient(clientConfig clientcmd.ClientConfig, debug bool, tlsEnabled bool) (
...
func NewKubeflowInClusterRecurringRunClient(namespace string, debug bool, tlsEnabled bool) (
	*RecurringRunClient, error) {
