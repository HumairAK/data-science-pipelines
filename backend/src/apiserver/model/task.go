...
type Task struct {
	...
	Fingerprint      string     `gorm:"column:Fingerprint; not null; type:varchar(255); index:idx_task_cache_lookup,priority:1;"`
	...
	State            TaskStatus `gorm:"column:State; not null; index:idx_task_cache_lookup,priority:2;"`
