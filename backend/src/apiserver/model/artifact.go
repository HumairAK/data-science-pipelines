...
type Artifact struct {
	...
	// TODO(Humair): Having an artifact name here might not make a lot of sense
	// since the artifact's name is dependent on the task context. The same artifact
	// that is an input to a task might have a different name than the artifact that
	// that is an output of an upstream task. It would make mor sense to tie this to
	// artifact_task.
