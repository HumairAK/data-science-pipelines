...
// validateFilterV2Beta1Metric creates filter contexts for metrics based on task IDs, run IDs, and namespace
func validateFilterV2Beta1Metric(taskIds, runIds []string, namespace string) ([]*model.FilterContext, error) {
