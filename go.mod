...
require (
	...
	github.com/kubeflow/model-registry v0.0.0-00010101000000-000000000000
...
replace (
	github.com/kubeflow/model-registry => github.com/dhirajsb/model-registry-kfp v0.0.0-20250626211727-4c4b164eb049
	github.com/kubeflow/pipelines/api => ./api
	github.com/kubeflow/pipelines/kubernetes_platform => ./kubernetes_platform

	// Model registry uses v0.32.3, but argo v3.5 breaks with this
	// argo 3.6 is on 0.33. For now we just patch the following as a workaround
