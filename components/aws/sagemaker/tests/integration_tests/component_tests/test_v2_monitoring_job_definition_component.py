...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "resources/factory/v2-monitoring-job-data-quality", marks=pytest.mark.v2
        ),
        pytest.param(
            "resources/factory/v2-monitoring-job-model-explainability",
            marks=pytest.mark.v2,
        ),
        pytest.param(
            "resources/factory/v2-monitoring-job-model-bias", marks=pytest.mark.v2
        ),
        pytest.param(
            "resources/factory/v2-monitoring-job-model-quality", marks=pytest.mark.v2
        ),
    ],
)
