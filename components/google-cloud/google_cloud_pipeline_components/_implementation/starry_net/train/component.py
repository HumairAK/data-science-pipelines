          ...
          'worker_pool_specs': [{
              ...
              'container_spec': {
                  ...
                  'args': [
                      ...
                      '--factory=analysis/trafficforecast/starryn/experiments/configs/vertex.py',
                      f'--factory.num_epochs={num_epochs}',
                      f'--factory.freeze_point_forecasts={freeze_point_forecasts}',
                      f'--factory.callbacks.tensorboard.n_decomposition_plots={n_decomposition_plots}',
                      f'--factory.datasets.backcast_length={backcast_length}',
                      f'--factory.datasets.forecast_length={forecast_length}',
                      f'--factory.datasets.train_end_date={train_end_date}',
                      f'--factory.datasets.train_path={csv_data_path}',
                      f'--factory.datasets.static_covariates_path={csv_static_covariates_path}',
                      f'--factory.datasets.static_covariates_vocab_path={static_covariates_vocab_path}',
                      f'--factory.datasets.train_tf_record_patterns={train_tf_record_patterns}',
                      f'--factory.datasets.val_tf_record_patterns={val_tf_record_patterns}',
                      f'--factory.datasets.test_tf_record_patterns={test_tf_record_patterns}',
                      f'--factory.datasets.n_val_windows={n_val_windows}',
                      f'--factory.datasets.val_rolling_window_size={test_set_stride}',
                      f'--factory.datasets.n_test_windows={n_test_windows}',
                      f'--factory.datasets.test_rolling_window_size={test_set_stride}',
                      f'--factory.datasets.nan_threshold={nan_threshold}',
                      f'--factory.datasets.zero_threshold={zero_threshold}',
                      f'--factory.model.regularizer_coeff={cleaning_activation_regularizer_coeff}',
                      f'--factory.model.activation_regularizer_coeff={change_point_activation_regularizer_coeff}',
                      f'--factory.model.output_regularizer_coeff={change_point_output_regularizer_coeff}',
                      f'--factory.model.alpha_upper_bound={alpha_upper_bound}',
                      f'--factory.model.beta_upper_bound={beta_upper_bound}',
                      f'--factory.model.phi_lower_bound={phi_lower_bound}',
                      f'--factory.model.b_fixed_val={b_fixed_val}',
                      f'--factory.model.b0_fixed_val={b0_fixed_val}',
                      f'--factory.model.phi_fixed_val={phi_fixed_val}',
                      f'--factory.model.quantiles={quantiles}',
                      f'--factory.model.use_static_covariates_trend={use_static_covariates}',
                      f'--factory.model.use_static_covariates_calendar={use_static_covariates}',
                      f'--factory.model.static_cov_names={static_covariate_names}',
                      f'--factory.model.blocks_list={model_blocks}',
                  ],
              },
          }]
      }
