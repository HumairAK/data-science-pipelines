...
def feature_transform_engine(
  ...
  return dsl.ContainerSpec(
      ...
      args=[
          ...
          '--feature_transform_engine_docker_uri=us-docker.pkg.dev/vertex-ai/automl-tabular/feature-transform-engine:20250129_0625',
          dsl.ConcatPlaceholder(
